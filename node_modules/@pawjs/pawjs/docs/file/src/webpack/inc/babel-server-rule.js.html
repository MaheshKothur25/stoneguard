...
<head>
  ...
  <title data-ice="title">src/webpack/inc/babel-server-rule.js | @pawjs/pawjs</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">src/webpack/inc/babel-server-rule.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">let presetEnv = require(&apos;@babel/preset-env&apos;);
