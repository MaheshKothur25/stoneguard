...
<head>
  ...
  <title data-ice="title">src/webpack/plugins/sw-variables.js | @pawjs/pawjs</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">src/webpack/plugins/sw-variables.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">class SwVariables {
  constructor(options = {}) {
