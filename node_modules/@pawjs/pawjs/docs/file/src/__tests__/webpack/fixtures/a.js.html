...
<head>
  ...
  <title data-ice="title">src/__tests__/webpack/fixtures/a.js | @pawjs/pawjs</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">src/__tests__/webpack/fixtures/a.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">module.exports = function a() {
  return &apos;This is a&apos;;
};
</code></pre>
